...
from apps.operations.views import OrderListCreateAPIView, OrderRetrieveUpdateDestroyAPIView, OpenedOrderListAPIView, \
    ...
    OrderTicketKitchenAPIView, AdditionalTicketAPIView, CloseOrderAPIView, CloseAllOrderAPIView, ReturnedOrderListCreateAPIView, ReturnedOrderRetrieveUpdateDestroyAPIView
